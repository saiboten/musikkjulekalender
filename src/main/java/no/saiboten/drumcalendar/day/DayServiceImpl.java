...
public class DayServiceImpl implements DayService {
	...
	private void fillWithDays() {
		...
		days.add(createDay(createDayTemplate(1),
				...
				"a51c90ce-32b0-4f39-b78d-4d487927faae", Arrays.asList("Iron Maiden"),
				Arrays.asList("Run to the Hills!")));
		days.add(createDay(createDayTemplate(2), "I denne låten er vokalisten sta. Spilt av Tobias",
				"cffc3630-e910-4e0b-8fb9-9cc4ca312f81", Arrays.asList("Rage Against the Machine"),
		...
		days.add(createDay(createDayTemplate(3), "Legendarisk trommebeat, denne gangen portrettert av Bjarte.",
				"4cf43a09-e5c8-4752-8505-3d2e24ea3d50", Arrays.asList("Toto"), Arrays.asList("Rosanna")));
		days.add(createDay(
				createDayTemplate(4),
		...
		days.add(createDay(
				...
				"2fa314f2-89f2-4bf7-aad0-42dbebc98be5", Arrays.asList("Guns N Roses", "Guns And Roses"),
		...
		days.add(createDay(
				...
				Arrays.asList("Soundgarden", "Sound garden"),
		...
		days.add(createDay(
				...
				Arrays.asList("Twisted Sisters", "Twisted Sister"),
		...
		days.add(createDay(
				...
				Arrays.asList("Dio", "Ronny James Dio"),
		...
		days.add(createDay(
				...
				Arrays.asList("The Police", "Police"),
		...
		days.add(createDay(createDayTemplate(15),
				...
				"f6d2731a-5ceb-4078-8ae9-6de67222c973", Arrays.asList("The Strokes", "Strokes"),
		...
		days.add(createDay(
				...
				"125d7530-99f6-4c99-9735-491346382ba3", Arrays.asList("Gojira"), Arrays.asList("Toxic Garbage Island")));
		...
		days.add(createDay(
				...
				"f7f9225d-4230-4f6f-8b39-1ef71d8d5384", Arrays.asList("Build to Spill"),
		...
		days.add(createDay(createDayTemplate(18),
				...
				"e3dca888-1431-4af2-a61f-1000e8abd615", Arrays.asList("Megadeth", "Mega deth"),
		...
		days.add(createDay(createDayTemplate(19), "Popballade med rockedel fra nyere tider. Tobias har laget denne.",
				"83ba2ba8-dab1-4377-810c-b254a8f95d15", Arrays.asList("Coldplay", "Cold play"),
		...
		days.add(createDay(createDayTemplate(20),
				...
				"b9c64d1c-aeaa-4e29-9db1-8f8eade7740b", Arrays.asList("Kvelertak"),
		...
		days.add(createDay(
				...
				"4181f202-6125-44da-a986-7238cd03abbd", Arrays.asList("Sting"), Arrays.asList("I Hung My Head")));
		...
		days.add(createDay(createDayTemplate(22),
				...
				"229af941-6409-4e06-9f0a-e8fcf09772d2", Arrays.asList("Radiohead", "Radio head"),
		...
		days.add(createDay(createDayTemplate(29), "En sang om blomster og fremgang? Tobias bak settet, igjen!",
				"d3c0f032-84a6-4e0e-aff3-58b09bebcf0b", Arrays.asList("Nirvana"), Arrays.asList("In Bloom")));
		...
		days.add(createDay(
				...
				"ca0aca3b-4dd5-4ebe-b06c-8c7d9d046935", Arrays.asList("Black Sabbath"), Arrays.asList("Iron Man")));
	}

	private Day createDay(Day day, String description, String link, List<String> solutionsArtist,
	...
	private Day createDay(Day day, String description, String link, List<String> solutionsArtist,
		...
		day.setSolutionsArtist(solutionsArtist);
