...
var Day = React.createClass({ displayName: "Day",
  ...
  render: function render() {
    ...
    return React.createElement("div", { className: "col-md-6 pane" }, React.createElement("h3", null, this.props.day.realDate, ". desember"), day);
  }
});
...
var UserResultDay = React.createClass({ displayName: "UserResultDay",
  ...
  render: function render() {
    ...
    return React.createElement("div", null, React.createElement("p", null, this.props.day.realDate, ". desember"), maybeempty);
  }
});
...
var CurrentUserResultDay = React.createClass({ displayName: "CurrentUserResultDay",
    ...
    render: function render() {
        ...
        if (answer && answer.correctSong) {
            answerComp = React.createElement("p", null, this.props.day.realDate, ". desember: ", answer.answerSong, " var riktig svar!");
        } else {
            answerComp = React.createElement("p", null, this.props.day.realDate, ". desember: Du fant ikke riktig svar.");
        }
